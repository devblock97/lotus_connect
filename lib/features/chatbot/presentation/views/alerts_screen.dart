  ...
  Widget _buildAlertCard(
    ...
    return Card(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(
          color: notification.isRead ? Colors.grey.shade100 : theme.colorScheme.primary.withValues(alpha: 0.15),
        ...
        onTap: () {
          ...
          if (data != null) {
            if (data['type'] == 'chat') {
              ...
              ref.read(shellIndexProvider.notifier).state = 2; // Switch bottom tab to Calls history
            }
          }
        },
        child: Padding(
